...
output_file('hbar.html', title="barchart.py Median Average of Rice Price Central America, West Africa and Middle East")
...
# y axis
regions = ['Middle East', 'West Africa', 'Central America']
...
p.hbar(y = regions, height=0.5, left=0,
       right=[median_i_range, median_j_range, median_h_range],fill_color="#ff6699", line_color = "black")
