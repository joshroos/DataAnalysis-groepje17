...
def rainfall_per_year():
    ...
    countries = rainfall['Country'].unique()

    for country in countries:
        for year in range(1991, 2015):
            pr_new = rainfall.loc[(rainfall['Year'] == year) &  (rainfall['Country'] == country), 'pr']
            pr_total = pr_new.sum()
...
def change_country_code(rainfall):
    ...
    for code in countries:
        ...
        rainfall.loc[rainfall['Country'] == code, 'Country'] = country[0]
